...
const TABS = ['contracts', 'entities', 'capital-control', 'government-changes', 'graph', 'municipios', 'campaign-finance']
    ...
    <div className="flex h-screen flex-col bg-background text-foreground">
      <header className="panel-glass flex items-center gap-2 border-b border-border px-4 py-2.5">
        ...
        <div>
          ...
          <p className="mt-0.5 text-[11px] text-muted-foreground">Puerto Rico public-money contracts, entities, capital &amp; campaign finance</p>
        </div>
      </header>
